...
<head>
    ...
    <link rel="shortcut icon" href="img/dave.ico">
    <title>Davids Profile</title>
    ...
    ======================================================-->
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
          <div class="my-auto" >
              ...
              <h1 class="mb-0">David
                <span class="text-primary">Mwasikira</span>
              </h1>
              <div class="subheading mb-5">TAKING SIMPLE IDEAS & TRANSFORMING THEM INTO THE NEXT BIG PRODUCT  
                  <a href="#">WITH TECHNOLOGY</a>
              </div>
              <p class="mb-5" style="max-width: 500px;" >I am experienced in Manufacturing Systems leveraging agile frameworks & Emerging Technologies to provide momentum and results in product development. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition.</p>
              <ul class="list-inline list-social-icons mb-0">
                  <li class="list-inline-item">
                      <a href="https://www.facebook.com/david.mwasikira/">
                  ...
                  <li class="list-inline-item">
                      <a href="https://twitter.com/DavidMwasikira">
                  <span class="fa-stack fa-lg">
                    <i class="fa fa-circle fa-stack-2x"></i>
                  ...
                  <li class="list-inline-item">
                      <a href="https://www.linkedin.com/in/david-mwasikira-a8867544/">
                  <span class="fa-stack fa-lg">
                    <i class="fa fa-circle fa-stack-2x"></i>
                  ...
                  <li class="list-inline-item">
                      <a href="https://github.com/DavidMwasikira?tab=repositories">
                  <span class="fa-stack fa-lg">
                    <i class="fa fa-circle fa-stack-2x"></i>
          ...
          <div class="row my-auto">
              ...
              <div class="resume-item col-md-6 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-globe mr-3 text-info"></i> Data Analytics Developer</h4>
                      <p>Identifying opportunities in the manufacturing sector & Utilities in advancing technology and optimizing processes on focusing solely on the bottom line
                      I.</p>
                  </div>
              ...
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #ffc107; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-laptop mr-3 text-warning"></i>  Plant Operations Manager</h4>
                      <p>Process Optimization: Delivering the right products to customers while maximizing investment returns,
                      Innovation & Technology Advancement: Assessing needs and Identifying opportunities with quick returns on investment,
                      Staff Motivation, Training & Reward: Improving productivity & work effectiveness delivering on business objectives and rewarding of outstanding performance.</p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">May 2013 - June 2019</span>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #28a745; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-camera mr-3 text-success"></i> Head of Engineering</h4>
                      <p>Project Implementation: Design, Consultation & Engineering Asset acquisition and implementation,
                      Facility & Asset Management: Implementation of World Class Engineering practice and Standards,Systems Engineering: Asset Reliability Engineering and Innovation to gain market competitive advantage,
                      Lean Implementation: Efficiency and Cost Management creating a product cost competitive advantage.                      
                      </p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">April 2008 - April 2013</span>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #2196f3; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-area-chart mr-3 text-primary"></i> Project Manager</h4>
                      <p>Liquefied CO2 Gas Project Installation & Commissioning,
                      Waste Water Treatment project: Recycling, savings 80%,
                      Black Steel coils HCL Pickling Line installation.</p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">September 2013 - Sept 2014</span>
                  </div>
                </div>  
              </div>
          </div>
          ...
          <div class="row my-auto">
              ...
              <div class="col-md-12">
                <div class="port-head-cont">
                  ...
                  <button class="btn btn-general btn-green filter-b" data-filter="consulting">Engineering Design</button>
                  <button class="btn btn-general btn-green filter-b" data-filter="finance">NLP Apps</button>
                  <button class="btn btn-general btn-green filter-b" data-filter="marketing">Web Design</button> 
                </div>
              </div>
          </div>
          <div class="row my-auto">
    ...
    ======================================================-->       
      <section class=" d-flex flex-column" id="skills">
         <div class="p-lg-5 p-3 skill-cover">
          <h3 class="text-center text-white">Data Analytics Skills</h3>
              ...
              <div class="main-award" id="award-box">
                  <div class="award">
                      ...
                      <div class="award-content">
                          <span class="date">Sept 2019 - Dec 2020</span>
                          <h5 class="title">MSc Data Analytics</h5>
                          <p class="description">
                              Masters course in Data Science in Rochester Institute of Technology (Dubai, UAE) 
                          </p>
                      </div>
                  </div>
                  <div class="award">
                      <div class="award-icon"></div>
                      <div class="award-content">
                          <span class="date">June 2019 - Jan 2020</span>
                          <h5 class="title">Engineered Asset Management Certification</h5>
                          <p class="description">
                              Post Grad Certification in University of Wollongong 
                          </p>
                      </div>
                  </div>
                  <div class="award">
                      <div class="award-icon"></div>
                      <div class="award-content">
                          <span class="date">Apr 2007 - Mar 2013</span>
                          <h5 class="title">Excellence in Engineering Leadership</h5>
                          <p class="description">
                              Received Crestcom BulletProof Manager Award (Nairobi, Kenya),
                              Engineering Managers Mentorship & Coaching Award (Diageo- Ghana)
                          </p>
                      </div>
                  </div>
                  <div class="award">
                      <div class="award-icon"></div>
                      <div class="award-content">
                          <span class="date">Apr 2003 - Mar 2014</span>
                          <h5 class="title">Project Management</h5>
                          <p class="description">
                              Received Advanced Project Management Certification in Sweden (SIDA Program)
                              Waste Water recycling project at CGI Glass received the Best Energy Star project implementation (Diageo).
                              In time and on budget project completion.
                          </p>
                      </div>
                  </div>
                  <div class="award">
                      <div class="award-icon"></div>
                      <div class="award-content">
                          <span class="date">Sept 1990 - May 1996</span>
                          <h5 class="title">B Tech. Production Engineering</h5>
                          <p class="description">
                              Undergrad Bachelors degree (Moi University - Kenya) in the field of Mechanical & Production Engineering.
                          </p>
                      </div>
                  </div>
              </div>
      ...
      <section class=" d-flex flex-column" id="maps">
        <div id="map">
          <div class="map-responsive">
            <iframe width="599" height="449" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=599&amp;height=449&amp;hl=en&amp;q=%20Dubai+(Portfolio)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> 
            <a href='http://maps-generator.com/'>add map to website</a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=d6f65710886165eee71534a3676c81b2de6b7c10'></script>
          </div>
